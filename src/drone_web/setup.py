...
setup(
    ...
    description='Web interfaces for KNR drone telemetry and control',
    ...
    entry_points={
        'console_scripts': [
            ...
            "webcam_dashboard=drone_web.webcam_dashboard:main",
            "ros_test_publisher=drone_web.ros_test_publisher:main",
        ],
    },
)
