...
collections.MutableMapping = collections.abc.MutableMapping  # dronekit 2.9.2 + Python 3.10 shim
...
class DroneHandler(Node):
    def __init__(self):
        ...
        #DECLARE GIMBAL (pitch w stopniach przez MAVLink gimbal manager -> Mount2/MAIN7)
